...
@endphp
    <div class="attendance-page">
        <div class="attendance-shell">
            <div class="attendance-topbar">
                <div class="attendance-greeting">
                    ...
                    <div class="user-nav">
                        ...
                        <a class="active" href="{{ route('user.final-report') }}">Final Report</a>
            ...
            <div class="hero-card">
                <div>
                    <div class="hero-title">Final Report Magang</div>
                    <div class="hero-subtitle">Unggah dokumen final report dan cek histori upload.</div>
                    @if ($errors->any())
                ...
                <div>
                    @if ($lastFinalReport)
                        <div class="alert alert-info mb-2">
                            Dokumen terakhir diunggah: {{ optional($lastFinalReport->created_at)->format('Y-m-d H:i') }}
                        </div>
                        <a class="btn btn-outline-primary action-button" href="{{ route('final-report.download', $lastFinalReport->id) }}">
                            Unduh Final Report Terakhir
                        </a>
                    @else
            ...
            <div class="action-card">
                <div class="action-header">
                    <div class="action-title">Upload Final Report</div>
                ...
                <form method="POST" action="{{ route('final-report.store') }}" class="action-form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="final_report">Upload Final Report (PDF)</label>
            ...
            <div class="logs-card">
                <div class="logs-title">Histori Final Report</div>
                @if ($reports->isEmpty())
