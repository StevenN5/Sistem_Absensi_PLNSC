    ...
    <ul class="navbar-right d-flex list-inline float-right mb-0">
        ...
        <li class="notification-list d-none d-md-block">
            <span class="nav-link waves-effect">
                <img src="assets/images/flags/indonesia_flag.jpg" class="mr-2" height="12" alt=""/> {{ __('global.indonesian') }}
            </span>
        </li>
        ...
        <li class="dropdown notification-list">
            <div class="dropdown notification-list nav-pro-img">
                ...
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                    ...
                    <a class="dropdown-item" href="#"><i class="mdi mdi-lock-open-outline m-r-5"></i> Kunci layar</a>
